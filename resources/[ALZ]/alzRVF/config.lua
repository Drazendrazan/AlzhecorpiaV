cfg = {
	deformationMultiplier = 1.9,					-- How much should the vehicle visually deform from a collision. Range 0.0 to 10.0 Where 0.0 is no deformation and 10.0 is 10x deformation. -1 = Don't touch. Visual damage does not sync well to other players.
...
repairCfg = {
	mechanics = {
		{name="Mécanicien", id=446, r=25.0, x=-337.0,  y=-135.0,  z=39.0},
		{name="Mécanicien", id=446, r=25.0, x=-1155.0, y=-2007.0, z=13.0},
		{name="Mécanicien", id=446, r=25.0, x=734.0,   y=-1085.0, z=22.0},
		{name="Mécanicien", id=446, r=25.0, x=1177.0,  y=2640.0,  z=37.0},
		{name="Mécanicien", id=446, r=25.0, x=108.0,   y=6624.0,  z=31.0},
		{name="Mécanicien", id=446, r=18.0, x=538.0,   y=-183.0,  z=54.0},
		{name="Mécanicien", id=446, r=15.0, x=1774.0,  y=3333.0,  z=41.0},
		{name="Mécanicien", id=446, r=15.0, x=1143.0,  y=-776.0,  z=57.0},
		{name="Mécanicien", id=446, r=30.0, x=2508.0,  y=4103.0,  z=38.0},
		{name="Mécanicien", id=446, r=16.0, x=2006.0,  y=3792.0,  z=32.0},
		{name="Mécanicien", id=446, r=25.0, x=484.0,   y=-1316.0, z=29.0},
		{name="Mécanicien", id=446, r=33.0, x=-1419.0, y=-450.0,  z=36.0},
		{name="Mécanicien", id=446, r=33.0, x=268.0,   y=-1810.0, z=27.0},
	  	{name="Mécanicien", id=446, r=24.0, x=288.0,   y=-1730.0, z=29.0},
		{name="Mécanicien", id=446, r=27.0, x=1915.0,  y=3729.0,  z=32.0},
		{name="Mécanicien", id=446, r=45.0, x=-29.0,   y=-1665.0, z=29.0},
		{name="Mécanicien", id=446, r=44.0, x=-212.0,  y=-1378.0, z=31.0},
		{name="Mécanicien", id=446, r=33.0, x=258.0,   y=2594.0,  z=44.0},
		{name="Mécanicien", id=446, r=18.0, x=-32.0,   y=-1090.0, z=26.0},
		{name="Mécanicien", id=446, r=25.0, x=-211.0,  y=-1325.0, z=31.0},
		{name="Mécanicien", id=446, r=25.0, x=903.0,   y=3563.0,  z=34.0},
		{name="Mécanicien", id=446, r=25.0, x=437.0,   y=3568.0,  z=38.0}
	},

	fixMessages = {
		"Vous avez ajouté de l'huile",
		"Vous arrêtez la fuite avec un chewing gum",
		"Un coup de scotch et c'est reparti",
		"Vous avez frappé le moteur, et bizarrement il est reparti de plus belle",
		"Vous avez retiré un peu de rouille sur l'échappement",
		"En criant sur votre moteur, celui-ci est reparti de plus belle"
	},
	fixMessageCount = 6,

	noFixMessages = {
		"En l'état, votre véhicule n'est pas réparable.",
		"Même crier ne peut réparer votre véhicule.",
		"Parfois, frapper son moteur le répare. Pas ici."
	},
	noFixMessageCount = 3
}

RepairEveryoneWhitelisted = true --FALSE = seulement les WL, TRUE = tout le monde
RepairWhitelist =
{
