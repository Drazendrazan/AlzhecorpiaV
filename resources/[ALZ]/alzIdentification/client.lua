...
RegisterNetEvent("alzIdentification:identify")
AddEventHandler("alzIdentification:identify", function(data, coords)
...
function ShowID()
    ...
    TriggerServerEvent("alzIdentification:identify", CurrentData)
...
RegisterNetEvent("alzIdentification:editID")
AddEventHandler("alzIdentification:editID", function(data)
    EditID()
end)

RegisterNetEvent("alzIdentification:showID")
AddEventHandler("alzIdentification:showID", function()
    ShowID()
end)

RegisterNetEvent("alzIdentification:set")
AddEventHandler("alzIdentification:set", function(data)
    SetIdentification(data)
end)
